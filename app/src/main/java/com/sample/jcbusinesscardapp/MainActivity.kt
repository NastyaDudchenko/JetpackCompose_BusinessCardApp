package com.sample.jcbusinesscardapp
...
import com.sample.jcbusinesscardapp.ui.theme.JCBusinessCardAppTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            JCBusinessCardAppTheme {
                Surface(
...
fun BusinessCard() {
    Column(
        ...
        val iconPhone = painterResource(id = R.drawable.ic_phone)
        val iconShare = painterResource(id = R.drawable.ic_share)
        val iconEmail = painterResource(id = R.drawable.ic_email)
